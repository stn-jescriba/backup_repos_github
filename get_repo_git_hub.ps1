try {
    ...
    $asunto = "GitHub: Respaldo exitoso"
    $mensaje = "Respaldo de github completado con éxito"
}
catch {
    $asunto = "GitHub: Error en el respaldo"
    $mensaje = "Ocurrio un error: $($_.Exception.Message)"
}

$smtpServer = $env:SMTP_SERVER
$puerto = $env:SMTP_PORT
$de = $env:SMTP_FROM
$para = $env:SMTP_TO.Split(';')

Send-MailMessage -From $de -To $para -Subject $asunto -Body $mensaje -SmtpServer $smtpServer -Port $puerto -UseSsl
